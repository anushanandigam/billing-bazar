...
$url = "https://api.goprocessing.in/billTrans.go?goid=$goid&apikey=$api&rtype=json&msisdn=$mbl_num&operator_code=$operator_ids&amount=$amount&service_family=$sf&client_trans_id=$client_trans_id&apimode=live";
