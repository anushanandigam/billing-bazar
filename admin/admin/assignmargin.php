...
alert(x);
var y= document.getElementById('plan_id').value;
alert(y);
$.post("ajax_assignmargin.php",{id:x,ids:y},function(result){
	alert(result);
...
<script>
							...
							<div role="tabpanel" class="tab-pane fade in active" >
                                    <form id="demo-form2" action="editbe.php" data-parsley-validate class="form-horizontal form-label-left">
